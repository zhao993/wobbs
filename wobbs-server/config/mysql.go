...
func InitDB(conf *MySQLConfig) *gorm.DB {
	...
	db.Create(&model.Category{BaseModel: model.BaseModel{ID: 2}, Name: "C++", Description: "C++社区"})
	db.Create(&model.Category{BaseModel: model.BaseModel{ID: 3}, Name: "LeeCode", Description: "算法社区"})
	db.Create(&model.Category{BaseModel: model.BaseModel{ID: 4}, Name: "王者荣耀", Description: "游戏社区"})
